# Contributing to Frequenz Electricity Trading API
...
sed 's|https://frequenz-floss.github.io/frequenz-api-common/v[0-9].[0-9]/objects.inv|https://frequenz-floss.github.io/frequenz-api-common/v/objects.inv|' -i mkdocs.yml
```
...
5. A GitHub action will test the tag and if all goes well it will create
   a [GitHub
   Release](https://github.com/frequenz-floss/frequenz-api-electricity-trading/releases),
   and upload a new package to
   [PyPI](https://pypi.org/project/frequenz-api-electricity-trading/)
   automatically.
