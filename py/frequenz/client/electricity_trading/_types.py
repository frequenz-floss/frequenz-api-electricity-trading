...
class Price:
    ...
    @classmethod
    def from_pb(cls, price: price_pb2.Price) -> Price:
...
class Energy:
    ...
    @classmethod
    def from_pb(cls, energy: energy_pb2.Energy) -> Energy:
...
class DeliveryArea:
    ...
    These ar, usually defined and maintained by a Transmission System Operator (TSO), where
    electricity deliveries for a contract occur.

    Attributes:
        code: Code representing the unique identifier for the delivery area.
        code_type: Type of code used for identifying the delivery area itself.
    """
    ...
    @classmethod
    def from_pb(cls, delivery_area: delivery_area_pb2.DeliveryArea) -> DeliveryArea:
...
class DeliveryPeriod:
    ...
    @classmethod
    def from_pb(
        cls, delivery_period: delivery_duration_pb2.DeliveryPeriod
    ) -> DeliveryPeriod:
...
class OrderState(enum.Enum):
    ...
    """The order has been cancelled. This can occur due to a cancellation request by the market
...
class Order:  # pylint: disable=too-many-instance-attributes
    ...
    Attributes:
        delivery_area: The delivery area where the contract is to be delivered.
        delivery_period: The delivery period for the contract.
        type: The type of order.
        side: Indicates if the order is on the Buy or Sell side of the market.
        price: The limit price at which the contract is to be traded.
        quantity: The quantity of the contract being traded.
        stop_price: Applicable for STOP_LIMIT orders. The stop price that triggers the limit order.
        peak_price_delta: Applicable for ICEBERG orders. The price difference between the peak
            price and the limit price.
        display_quantity: Applicable for ICEBERG orders. The quantity of the order to be displayed
            in the order book.
        execution_option: Order execution options such as All or None, Fill or Kill, etc.
        valid_until: UTC timestamp defining the time after which the order should be cancelled if
            not filled.
        payload: User-defined payload individual to a specific order. This can be any data that
            needs to be associated with the order.
        tag: User-defined tag to group related orders.
    """
    ...
    @classmethod
    def from_pb(cls, order: electricity_trading_pb2.Order) -> Order:
...
class StateDetail:
    ...
    Attributes:
        ...
        market_actor: Actor responsible for the current state.
    """
...
class OrderDetail:
    ...
    @classmethod
    def from_pb(cls, order_detail: electricity_trading_pb2.OrderDetail) -> OrderDetail:
...
class PublicTrade:  # pylint: disable=too-many-instance-attributes
    ...
    Attributes:
        public_trade_id: ID of the order from the public order book.
        buy_delivery_area: Delivery area code of the buy side.
        sell_delivery_area: Delivery area code of the sell side.
        delivery_period: The delivery period for the contract.
        modification_time: UTC Timestamp of the last order update or matching.
        price: The limit price at which the contract is to be traded.
        quantity: The quantity of the contract being traded.
    ...
    @classmethod
    def from_pb(cls, public_trade: electricity_trading_pb2.PublicTrade) -> PublicTrade:
...
class GridpoolOrderFilter:
    ...
    Attributes:
        ...
        tag: Tag associated with the orders to be filtered.
    """
...
class PublicTradeFilter:
    ...
    Attributes:
        ...
        delivery_period: Delivery period to filter for.
        buy_delivery_area: Delivery area to filter for on the buy side.
        sell_delivery_area: Delivery area to filter for on the sell side.
...
class UpdateOrder:  # pylint: disable=too-many-instance-attributes
    ...
    Args:
        ...
        stop_price: Applicable for STOP_LIMIT orders. This is the updated stop price that triggers
            the limit order.
        ...
        display_quantity: Applicable for ICEBERG orders. This is the updated quantity of the order
            to be displayed in the order book.
        execution_option: Updated execution options such as All or None, Fill or Kill, etc.
        valid_until: This is an updated timestamp defining the time after which the order should
            be cancelled if not filled. The timestamp is in UTC.
        payload: Updated user-defined payload individual to a specific order. This can be any data
